...
The residuals plots in @fig-m2-plot, @fig-m3-plot and @fig-m4-plot all appear to show there is not any residual variance.
...
```{r}
#| label: tbl-ranova-m2
#| tbl-cap: "The results of the function `ranova` applied to the mixed effects model with concentration and treatment (and the interaction term between these predictors) as fixed effects, showing that the random effect term is statistically significant."
ranova(m2) %>% 
...
```{r}
#| label: tbl-ranova-m4
#| tbl-cap: "The results of the function `ranova` applied to the mixed effects model with concentration, treatment and cell line (and the interaction terms between these predictors) as fixed effects, showing that the random effect term is statistically significant."
ranova(m4) %>% 
  kable(digits = c(0,4,4,5,4,25))
```

...
# summary(m1)
mtab2df(tab_model(m1), n_models = 1, output = "kable", booktabs = TRUE)
```
...
# summary(m2)
mtab2df(tab_model(m2), n_models = 1, output = "kable", booktabs = TRUE)
```
...
# summary(m3)
mtab2df(tab_model(m3), n_models = 1, output = "kable", booktabs = TRUE)
```

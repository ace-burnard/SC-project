...
The statistical significance of each term in the fixed effects model is shown in @tbl-sjPlot-step, which shows that all of the terms are statistically significant.

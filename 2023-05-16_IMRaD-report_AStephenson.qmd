...
The statistical significance of the terms in the selected model can be found using an ANOVA test. @tbl-sjPlot-step shows the results of the ANOVA test conducted upon the selected fixed effect model, which shows that all of the terms are statistically significant.

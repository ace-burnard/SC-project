...
```{r}
#| label: tbl-ranova-m2
#| tbl-cap: "An ANOVA table showing the statistical significance of the random effect term in the mixed effects model with concentration and treatment (and the interaction term between these predictors) as fixed effects, showing that the gene line random effect term is statistically significant."
ranova(m2) %>% kable(digits = c(0, 4, 4, 5, 4, 25))
```

```{r}
#| label: tbl-ranova-m4
#| tbl-cap: "An ANOVA table showing the statistical significance of the random effect term in the mixed effects model with concentration, treatment and cell line (and the interaction terms between these predictors) as fixed effects, showing that the gene line random effect term is statistically significant."

...
mixed_effects_model1 <- m2
mixed_effects_model2 <- m4
compare_performance(fixed_effects_model, mixed_effects_model1, mixed_effects_model2) %>% 
  select(c("Name", "AIC", "R2", "R2_conditional", "RMSE")) %>% 
  rename("conditional R2" = "R2_conditional") %>% 
...
#| tbl-cap: "The difference from the average intercept for each gene line."

...
bxp <- ggdotplot(data_aov,
                 ...
                 binwidth = 1)
bxp
ggsave("figures/conc-ge-grouping_scatterplot.svg", width = 2*plot_height, height = plot_height)
```
...
ggsave("figures/conc-ge-grouping_scatterplot_labelled.svg", width = 2*plot_height, height = plot_height)
```
